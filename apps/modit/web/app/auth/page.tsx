    ...
    <div className="min-h-screen bg-[#F8F6FC] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          ...
          <h1 className="text-[24px] font-black text-[#150726]">Sign in to MODIT</h1>
          <p className="mt-1 text-[13px] text-[#9B8CB5]">Construction materials delivered to your site</p>
        </div>
        ...
        <div className="rounded-2xl border border-[#DDD6EE] bg-white p-6 shadow-sm">
          ...
          >
            {error && (
              <div className="rounded-xl bg-red-50 border border-red-200 p-3 text-[12px] font-medium text-red-600">
                {error}
              </div>
            )}
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                <label className="text-[12px] font-bold text-[#150726]">Password</label>
                <Link href="/auth/forgot-password" className="text-[11px] font-semibold text-[#2D1B69] hover:underline">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
            ...
            <button
              ...
              className="w-full h-11 rounded-xl bg-[#2D1B69] text-white text-[14px] font-bold hover:bg-[#1E1245] transition-all hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-purple-900/25 disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <div className="relative my-5">
            <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-[#DDD6EE]" /></div>
          ...
          <button
            ...
            className="w-full h-10 rounded-xl border-2 border-[#DDD6EE] bg-white text-[13px] font-semibold text-[#150726] hover:border-[#2D1B69] hover:bg-[#F8F6FC] transition-all flex items-center justify-center gap-2"
          >
          ...
          <p className="mt-5 text-center text-[12px] text-[#9B8CB5]">
            ...
            <Link href="/auth/register" className="font-bold text-[#2D1B69] hover:underline">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
