...
const PRODUCTS = [
  { id: "cement-1", name: "UltraTech Cement OPC 43 Grade 50kg", brand: "UltraTech", price: 370, mrp: 490, discount: 24, rating: 4.7, reviews: 2340, img: "/modit-placeholder.svg", badge: "Bestseller", category: "Cement", supplier: "BuildMart India", delivery: "Tomorrow" },
  { id: "steel-1", name: "Tata Tiscon TMT 500D 12mm Bars", brand: "Tata", price: 58500, mrp: 67000, discount: 13, rating: 4.8, reviews: 1890, img: "/modit-placeholder.svg", badge: "Top Rated", category: "Steel", supplier: "SteelSupply Co.", delivery: "2 days" },
  { id: "paint-1", name: "Asian Paints Apex 20L Exterior Emulsion", brand: "Asian Paints", price: 2400, mrp: 3100, discount: 23, rating: 4.6, reviews: 4230, img: "/modit-placeholder.svg", badge: "Popular", category: "Paint", supplier: "PaintWorld", delivery: "Tomorrow" },
  { id: "tiles-1", name: "Kajaria Wall Tiles 2x2ft Glossy Finish", brand: "Kajaria", price: 42, mrp: 55, discount: 24, rating: 4.5, reviews: 3120, img: "/modit-placeholder.svg", badge: "New", category: "Tiles", supplier: "TileHub", delivery: "3 days" },
  { id: "electrical-1", name: "Havells LifeLine Plus 2.5sqmm Wire 90m", brand: "Havells", price: 2520, mrp: 2800, discount: 10, rating: 4.8, reviews: 534, img: "/modit-placeholder.svg", badge: "Trusted", category: "Electrical", supplier: "ElectroBazaar", delivery: "Tomorrow" },
  { id: "plumbing-1", name: "Jaquar CP Valve 1/2 Inch Full Flow", brand: "Jaquar", price: 890, mrp: 1200, discount: 26, rating: 4.4, reviews: 876, img: "/modit-placeholder.svg", badge: "Deal", category: "Plumbing", supplier: "PlumbPro", delivery: "2 days" },
  { id: "cement-2", name: "ACC Cement 2X Strong 50kg Bag", brand: "ACC", price: 365, mrp: 475, discount: 23, rating: 4.6, reviews: 1890, img: "/modit-placeholder.svg", badge: "Value", category: "Cement", supplier: "BuildMart India", delivery: "Tomorrow" },
  { id: "steel-2", name: "JSW Neosteel TMT 500D 10mm Premium", brand: "JSW", price: 54200, mrp: 62000, discount: 12, rating: 4.7, reviews: 1245, img: "/modit-placeholder.svg", badge: "Premium", category: "Steel", supplier: "SteelSupply Co.", delivery: "2 days" },
  { id: "tiles-13", name: "Kajaria Digital Wall Tiles 2x3 ft", brand: "Kajaria", price: 65, mrp: 85, discount: 24, rating: 4.6, reviews: 278, img: "/modit-placeholder.svg", badge: "New", category: "Tiles", supplier: "Kajaria Premium", delivery: "3 days" },
  { id: "tiles-14", name: "Somany Marble Look Floor Tiles 2x2 ft", brand: "Somany", price: 104, mrp: 120, discount: 13, rating: 4.7, reviews: 204, img: "/modit-placeholder.svg", badge: "Premium", category: "Tiles", supplier: "Somany Marble Series", delivery: "4 days" },
  { id: "tiles-15", name: "Johnson Subway Wall Tiles 3x9 in", brand: "Johnson", price: 52, mrp: 61, discount: 15, rating: 4.4, reviews: 97, img: "/modit-placeholder.svg", badge: "New", category: "Tiles", supplier: "Johnson Design Studio", delivery: "3 days" },
  { id: "paint-4", name: "Asian Paints Royale Luxury 20L", brand: "Asian Paints", price: 5200, mrp: 5800, discount: 10, rating: 4.8, reviews: 567, img: "/modit-placeholder.svg", badge: "Premium", category: "Paint", supplier: "Color World", delivery: "Tomorrow" },
  { id: "sanitary-1", name: "Cera EWC Sanitary Ware", brand: "Cera", price: 7650, mrp: 8500, discount: 10, rating: 4.5, reviews: 156, img: "/modit-placeholder.svg", badge: "Deal", category: "Sanitary", supplier: "Cera Showroom", delivery: "3 days" },
  { id: "plywood-1", name: "Greenply BWR Plywood 19mm 8x4 ft", brand: "Greenply", price: 3200, mrp: 3800, discount: 16, rating: 4.6, reviews: 287, img: "/modit-placeholder.svg", badge: "Trusted", category: "Plywood", supplier: "Greenply Dealer", delivery: "3 days" },
];
