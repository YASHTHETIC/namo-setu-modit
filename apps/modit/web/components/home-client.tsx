...
import { ArrowRight, CheckCircle2, Layers3, Menu, ShieldCheck } from "lucide-react";
    ...
    <main className="mx-auto flex min-h-screen w-full max-w-7xl flex-col gap-10 px-4 py-6 sm:px-6 lg:px-8">
      ...
      <section className="grid gap-4 text-sm text-slate-600 sm:grid-cols-3">
        <div className="rounded-2xl border border-slate-200 bg-white/80 p-4">
          <Layers3 className="mb-3 h-5 w-5 text-[rgb(var(--brand))]" />
          MODIT stays focused on procurement, pricing, inventory, and fulfillment.
        </div>
        <div className="rounded-2xl border border-slate-200 bg-white/80 p-4">
