...
function BookingContent() {
      ...
      <PageFrame>
        <div className="max-w-2xl mx-auto text-center animate-[scaleIn_0.5s_ease-out]">
          <div className="mb-10 animate-[fadeIn_0.4s_ease-out_0.2s_both]">
            <div className="mx-auto flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-br from-emerald-400 to-green-500 shadow-2xl shadow-emerald-500/30 animate-[scaleIn_0.3s_ease-out_0.3s_both]">
  ...
  return (
    <PageFrame>
      {/* Progress Steps */}
      <div className="flex items-center justify-center gap-3 animate-[fadeIn_0.4s_ease-out]">
